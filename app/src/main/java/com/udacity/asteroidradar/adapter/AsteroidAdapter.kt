    ...
    class AsteroidViewHolder(private val binding: ListItemBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(asteroid: Asteroid) {
            ...
            if (asteroid.isPotentiallyHazardous) {
                binding.asteroidStatusIcon.contentDescription = itemView.context.getString(R.string.potentially_hazardous_asteroid_image)
            } else {
                binding.asteroidStatusIcon.contentDescription = itemView.context.getString(R.string.not_hazardous_asteroid_image)
            }
